...
const Explore = ({list}) => {
  return (
    <div className='max-width explore-section' style={{marginTop:'16px'}}>
    <div className='explore-grid' style={{display:'flex',flexWrap:'wrap',justifyContent:'space-between'}}>
        {/* {list.map((restaurant)=>{
